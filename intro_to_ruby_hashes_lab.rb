...
def monopoly_with_third_tier
  ...
  # they'll guide you in how to modify what you just did to have more
  # complexity.
  {:railroads => {:pieces => 4, :rent_in_dollars => {:one_piece_owned => 25, :two_pieces_owned => 50, :three_pieces_owned => 100, :four_pieces_owned => 200}, :names =>{:reading_railroads => {}, :penssylvania_railroads => {}, :b_and_o_railraods => {}, :shortline => {}}}}
end
